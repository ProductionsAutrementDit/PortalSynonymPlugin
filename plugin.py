...
class SynonymsBootstrap(Plugin):
    ...
    def bootstrap(self):
        from portal.plugins.synonyms.plistner import synonyms_item_pre_modify_handler
        from portal.vidispine.signals import vidispine_pre_modify, vidispine_pre_create
